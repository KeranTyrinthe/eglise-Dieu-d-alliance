    ...
    <main class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">${{ number_format($stats['revenus_mois'], 0, ',', ' ') }}
                </p>
            </div>
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">${{ number_format($stats['revenus_annuels'], 0, ',', ' ') }}
                </p>
            </div>
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">${{ number_format($stats['offrandes_mois'], 0, ',', ' ') }}
                </p>
            </div>
        </div>
                ...
                <div class="carousel-container">
                    ...
                    <div class="carousel-slide active">
                        <div class="bg-blue-900 rounded-2xl p-8 text-white">
                            ...
                            <div class="space-y-6">
                                @foreach($repartitionType as $item)
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="text-lg font-medium">{{ $item['type'] }}</span>
                                            <span class="text-lg font-bold">{{ $item['pourcentage'] }}%</span>
                                        </div>
                    ...
                    <div class="carousel-slide">
                        <div class="bg-red-700 rounded-2xl p-8 text-white">
                            ...
                            <div class="space-y-6">
                                @foreach($methodesPaiement as $item)
                                    <div>
                                        <div class="flex items-center justify-between mb-2">
                                            <span class="text-lg font-medium">{{ $item['methode'] }}</span>
                                            <span class="text-lg font-bold">{{ $item['pourcentage'] }}%</span>
                                        </div>
