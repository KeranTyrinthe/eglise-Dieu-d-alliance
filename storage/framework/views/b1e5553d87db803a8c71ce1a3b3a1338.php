    ...
    <main class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">$<?php echo e(number_format($stats['revenus_mois'], 0, ',', ' ')); ?></p>
            </div>
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">$<?php echo e(number_format($stats['revenus_annuels'], 0, ',', ' ')); ?></p>
            </div>
            ...
            <div class="stat-card bg-white rounded-xl p-6 shadow-md">
                ...
                <p class="text-2xl font-bold text-gray-900">$<?php echo e(number_format($stats['offrandes_mois'], 0, ',', ' ')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md mb-6">
            <div class="flex border-b px-6">
                <a href="<?php echo e(route('finances.dashboard')); ?>" class="tab-active px-6 py-3 font-medium rounded-t-lg">Vue
                    d'ensemble</a>
            ...
            <div class="p-6">
                ...
                <!-- Chart -->
                <div class="space-y-4">
                    <?php $__currentLoopData = $evolutionRevenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mois): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-xs font-medium text-gray-700"><?php echo e($mois['mois']); ?></span>
                                <span class="text-sm font-bold text-gray-900">$<?php echo e(number_format($mois['total'], 0, ',', ' ')); ?></span>
                            </div>
                            <div class="flex h-8 rounded-lg overflow-hidden">
                                <div class="bg-purple-500 flex items-center justify-center text-white text-xs font-medium"
                                    style="width: <?php echo e(($mois['dimes'] / $mois['total']) * 100); ?>%">
                                    $<?php echo e(number_format($mois['dimes'], 0, ',', ' ')); ?>

                                </div>
                                <div class="bg-blue-500 flex items-center justify-center text-white text-xs font-medium"
                                    style="width: <?php echo e(($mois['offrandes'] / $mois['total']) * 100); ?>%">
                                    $<?php echo e(number_format($mois['offrandes'], 0, ',', ' ')); ?>

                                </div>
                                <div class="bg-green-500 flex items-center justify-center text-white text-xs font-medium"
                                    style="width: <?php echo e(($mois['dons_speciaux'] / $mois['total']) * 100); ?>%">
                                    $<?php echo e(number_format($mois['dons_speciaux'], 0, ',', ' ')); ?>
...
</html><?php /**PATH C:\laragon\www\eglise-Dieu-d-alliance\resources\views/backoffice/gestion-financiere/dashboard.blade.php ENDPATH**/ ?>