...
<div id="transactionModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4">
        ...
        <!-- Modal Body -->
        <form action="<?php echo e(route('finances.store')); ?>" method="POST" class="p-6 space-y-4">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\eglise-Dieu-d-alliance\resources\views/components/nouvelle-transaction-modal.blade.php ENDPATH**/ ?>